...
agregarProductoCarrito():void{
  ...
  //de momento para comprobar que esta funcionando el carrito:
    ...
    this.miServicio.agregarAlCarrito(this.idReloj,1).subscribe(res => (res=="ok")?alert("producto agregado al carrito" +res):alert("no se pudo agregar el producto al carrito"+res) );
}
